...
(function (factory) {
    ...
    PNotify.prototype.modules.buttons = {
        ...
        init: function(notice, options){
            ...
            .bind("pnotify_icon", function(){
                    ...
                    $(this).children().load(xoops.url("/media/xoops/icons/" + (notice.options.hide ? 'pause-circle.svg' : 'play-circle.svg')))
            })
            .append($("<span />", {
                    "class": notice.styles.pin_up,
                    "title": options.labels.stick
                })
                    .load(xoops.url("/media/xoops/icons/pause-circle.svg")))
            ...
            .append($("<span />", {"class": notice.styles.closer, "title": options.labels.close})
                    .load(xoops.url('/media/xoops/icons/times-circle.svg')))
            .prependTo(notice.container);
    ...
    $.extend(PNotify.styling.brighttheme, {
        closer: "xo-icon-svg",//"brighttheme-icon-closer",
        pin_up: "xo-icon-svg",
        pin_down: "xo-icon-svg"
    });
