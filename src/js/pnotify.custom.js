...
(function (factory) {
	...
	$.extend(PNotify.prototype, {
		...
		init: function(){
			...
			this.styles = PNotify.styling['bootstrap3'];
			//}
			...
			this.container = $("<div />", {"class": this.styles.container+" ui-pnotify-container "+this.styles[this.options.type]})
                .appendTo(this.elem);
	...
	$.extend(PNotify, {
		...
		styling: {
			bootstrap3: {
				...
				warning_icon: "glyphicon glyphicon-exclamation-sign",
				info: "alert-info",
                ...
                azure: "alert-azure",
                sky: "alert-sky",
                palegreen: "alert-palegreen",
                orange: "alert-orange",
                yellow: "alert-yellow",
                pink: "alert-pink",
                midnight: "alert-midnight",
                indigo: "alert-indigo",
                brown: "alert-brown",
                magenta: "alert-magenta",
                green: "alert-green",
                purple: "alert-purple",
                alizarin: "alert-alizarin"
			}
		}
	});
	/*
