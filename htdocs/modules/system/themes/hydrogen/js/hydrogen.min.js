...
!function(t){t.fn.xoPreload=function(e){var n=t.extend({action:"show",position:"absolute"},e);return this.each(function(){if("hide"==n.action)return t(this).find(".xo-preload-animation").remove(),t(this).find(".xo-preload-overlay").remove(),!0;if(t(this).find(".xo-preload-overlay").length>0)return t(this).find(".xo-preload-overlay").css("position",n.position),t(this).find(".xo-preload-animation").css("position",n.position),t(this).find(".xo-preload-overlay").fadeIn(250),t(this).find(".xo-preload-animation").fadeIn(250),!0;var e='<div class="xo-preload-overlay" style="position: '+n.position+';"></div><div class="xo-preload-animation" style="position: '+n.position+';"><span id="xo-preload-animation_1"></span><span id="xo-preload-animation_2"></span><span id="xo-preload-animation_3"></span></div>',o=t(this).css("position");"absolute"!=o&&"relative"!=o&&"fixed"!=o&&t(this).css("position","relative"),t(this).append(e),t(this).find(".xo-preload-overlay").fadeIn(250,function(){t(this).siblings(".xo-preload-animation").fadeIn(250)})})}}(jQuery);
!function(e){e(document).ready(function(){e("#hydrogen-sidebar").perfectScrollbar(),e("#installed-modules").length>0&&e("#installed-modules, #installed-extensions").perfectScrollbar({useBothWheelAxes:!1,suppressScrollX:!0}),e("#dashboard-users-list").length>0&&e("#dashboard-users-list .table-responsive").perfectScrollbar(),e("#xo-toolbar .alert-button").length>0&&e("#xo-toolbar .alert-button .messages-container").perfectScrollbar({suppressScrollX:!0}),e(".xo-toolbar").length>0&&e(".xo-toolbar").perfectScrollbar({useBothWheelAxes:!0,suppressScrollY:!0}),e(".hydrogen-sidebar ul > li.menu > a:first-child").click(function(){return e(this).siblings(".nav-menu").is(":visible")?(e(this).siblings(".nav-menu").slideUp(250),e(this).parent().removeClass("open"),!1):(e(".hydrogen-sidebar ul .nav-menu:visible").each(function(t){e(this).slideUp(250),e(this).parent().removeClass("open")}),e(this).siblings(".nav-menu").slideToggle(250),e(this).parent().addClass("open"),!1)}),e("#xo-toolbar .menu-toggler > .menu-toggle").click(function(){e("body").toggleClass("collapsed-sidebar"),e("body").hasClass("collapsed-sidebar")?Cookies.set("hydrogensb",1,{expires:30,path:"/"}):Cookies.remove("hydrogensb",{path:"/"})}),e(".hydrogen-sidebar .nav-separator a").click(function(){var t=e(this).data("siblings");return""==t?!1:(e(".hydrogen-sidebar li."+t).fadeToggle(250),!1)}),e("body").on("click",".xo-panel > .panel-heading > .collapse",function(){e(this).toggleClass("collapsed"),e(this).parent().siblings(".collapsable").slideToggle(250)})})}(jQuery);
