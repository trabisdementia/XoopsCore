            ...
            <section>
                ...
                <div class="module-options">
                    ...
                    <{if $module->getInfo('can_disable')}>
                        <a href="#" data-action="module-uninstall" data-mid="<{$module->getVar('mid')}>" title="<{translate key='A_UNINSTALL'}> <{$module->getVar('name')}>">
                            <{xoicon icon="xicon-minus-circle-o" class="text-danger"}>
                        </a>
                        <a href="#" data-action="module-active" data-mid="<{$module->getVar('mid')}>" title="<{translate key='ENABLE_DISABLE'}> <{$module->getVar('name')}>">
