            ...
            <section>
                ...
                <div class="module-options">
                    ...
                    <{if $module->getInfo('can_disable')}>
                        <a href="#" data-action="module-uninstall" data-id="<{$module->getVar('mid')}>" title="<{translate key='A_UNINSTALL'}> <{$module->getVar('name')}>">
                            <{xoicon icon="xicon-minus-circle-o" class="text-danger"}>
                        </a>
                        <a href="#" data-action="module-active" data-id="<{$module->getVar('mid')}>" title="<{translate key='ENABLE_DISABLE'}> <{$module->getVar('name')}>">
                    ...
                    <{/if}>
                    <a href="#" data-action="module-update" data-id="<{$module->getVar('mid')}>" title="<{translate key='A_UPDATE'}>
                    <{$module->getVar('name')}>">
                        <{xoicon icon="xicon-update" class="text-green"}>
                    </a>

                    <a href="#" data-action="module-info" data-id="<{$module->getVar('mid')}>" title="<{translate key='DETAILS'}>">
